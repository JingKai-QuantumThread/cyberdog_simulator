...
private:
    ...
    float          stair_height_vel_cur_   = 0.0f;
    float          stair_last_safe_height_ = 0.0f;
    bool           stair_height_unsafe_    = false;
    ...
    void SetStairMotionParams( const int gait_id );
    ...
    bool IsStairMotionGait( int gait_id ) const;
    void ApplyStairHeightSafety();
