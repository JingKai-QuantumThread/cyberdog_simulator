...
public:
    ...
    UserParameters()
        : ControlParameters( "user-parameters" ),
          ...
          INIT_PARAMETER( rpy_acc_max ), INIT_PARAMETER( rpy_w_max ), INIT_PARAMETER( rpy_min ), INIT_PARAMETER( rpy_max ), INIT_PARAMETER( qp_stand_height_min ),
          INIT_PARAMETER( qp_stand_height_max ), INIT_PARAMETER( pose_transform_height_min ), INIT_PARAMETER( pose_transform_height_max ), INIT_PARAMETER( user_gait_height_min ),
          INIT_PARAMETER( user_gait_height_max ), INIT_PARAMETER( user_gait_height_vel_max ), INIT_PARAMETER( user_gait_height_acc_max ),
    ...
    DECLARE_PARAMETER( double, qp_stand_height_min );
    DECLARE_PARAMETER( double, qp_stand_height_max );
    DECLARE_PARAMETER( double, pose_transform_height_min );
    DECLARE_PARAMETER( double, pose_transform_height_max );
    DECLARE_PARAMETER( double, user_gait_height_min );
    DECLARE_PARAMETER( double, user_gait_height_max );
    DECLARE_PARAMETER( double, user_gait_height_vel_max );
    DECLARE_PARAMETER( double, user_gait_height_acc_max );
